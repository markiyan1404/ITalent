...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"../node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _navigation_ts_components_check_page_language__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../navigation/ts/components/check_page_language */ \"./navigation/ts/components/check_page_language.ts\");\n\n\nvar page = jquery__WEBPACK_IMPORTED_MODULE_0__(window),\n    timeChangeHead = 3000; // Check focus\n\nvar changeIcon = function changeIcon(typeIcon) {\n  var activeColor = localStorage.getItem(\"color\");\n  activeColor !== null ? activeColor = activeColor.substring(1) : activeColor = \"FFC700\";\n  jquery__WEBPACK_IMPORTED_MODULE_0__(\"link[rel*='icon']\").attr(\"href\", \"img/head/\" + activeColor + \"-\".concat(typeIcon, \".webp\"));\n};\n\npage.on(\"blur\", function () {\n  setTimeout(function () {\n    var appLang = localStorage.getItem(\"lang\");\n    if (appLang === \"ua\") document.title = \"Верніться 😭\";\n    if (appLang === \"en\") document.title = \"Come back 😭\";\n    if (appLang === \"es\") document.title = \"Regresar 😭\";\n    changeIcon(\"noActiveIcon\");\n  }, timeChangeHead);\n});\npage.on(\"focus\", function () {\n  var appLang = localStorage.getItem(\"lang\");\n  (0,_navigation_ts_components_check_page_language__WEBPACK_IMPORTED_MODULE_1__.contentUpdate)(appLang);\n  changeIcon(\"activeIcon\");\n});\npage.on(\"load\", function () {\n  var appLang = localStorage.getItem(\"lang\");\n  (0,_navigation_ts_components_check_page_language__WEBPACK_IMPORTED_MODULE_1__.contentUpdate)(appLang);\n  changeIcon(\"activeIcon\");\n});\n\n//# sourceURL=webpack:///./ts/title.ts?");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_jquery_dist_jquery_js"], function() { return __webpack_require__("./ts/title.ts"); })
